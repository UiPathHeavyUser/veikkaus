...
f = open("c://pythonprojects//veikkaus//lotto7jackpot.txt","w")
row_number= 1
end_date = "4.12.2016"
...
while drange[-9:] != end_date:
    ...
    try:
        ...
        f.write("0")
    f.write("\n")
    driver.find_element_by_css_selector("button.pagination-navigate.pagination-prev.button.button-square.button-primary-blue").click()
    drange = driver.find_element_by_css_selector(".date-range").text
    row_number +=1
